...
<div class="container mt-3 bg-white p-5">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <span style='font-weight:normal'>As on {{ now()->format('d F Y') }} ({{ now()->formatLocalized('%A') }})</span><br><br>
      ...
      <div class="col-12 mt-5">
        ...
        <div class='section-top-border'>
            ...
            <div class='row'>
                <div class='col-md-4'>
                    <div class='single-defination section-leftright-border text-center' style='box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 2px dashed #2c2c2c; padding: 15px;'>
                        <p class='goldratehome' style="color:#2c2c2c; !important;font-weight:bold"><b>Rs. <span id="OUNCE24">528410</span></b></p>
                        <p>24 Karat Gold Rate</p>
                    </div>
                </div>
                <div class='col-md-4'>
            ...
            <div class='row'>
                <div class='col-md-4'>
                    <div class='single-defination section-leftright-border text-center' style='box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 2px dashed #2c2c2c; padding: 15px;'>
                        <p class='goldratehome' style="color:#2c2c2c; !important;font-weight:bold"><b>Rs. <span id="OUNCE18">396308</span></b></p>
                        <p>18 Karat Gold Rate</p>
                    </div>
                </div>
                <div class='col-md-4'>
