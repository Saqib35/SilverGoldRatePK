...
<script>
            ...
            $('#users-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'slug', name: 'slug'},
                    {data: 'image_path_one', name: 'image_path_one'},
                    {data: 'image_path_two', name: 'image_path_two'},
                    {data: 'image_path_three', name: 'image_path_three'},
